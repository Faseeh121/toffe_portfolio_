...
// Generate image paths for Service_provider_App folder (1.jpeg – 7.jpeg)
const appImages = Array.from({ length: 7 }, (_, i) => `/images/apps%20images/Service_provider_App/${i + 1}.jpeg`);
...
interface Service_Provider_AppProps {
  onBack?: () => void;
}
...
/* ================================================================
   MAIN COMPONENT
   ================================================================ */
export default function Service_Provider_App({ onBack }: Service_Provider_AppProps) {
  ...
  const features = [
    { icon: "\ud83c\udf54", title: "Multi-Service Provider Browse", desc: "Customers can explore services from multiple local providers, with categorized listings and real-time availability." },
    { icon: "\ud83d\udcca", title: "Custom Service Pricing", desc: "Each service displays detailed information \u2014 ratings, reviews, and availability details." },
    { icon: "\ud83d\udd14", title: "Real-time Booking Tracking", desc: "Live booking status updates from request to completion, powered by Firebase Realtime Database." },
    { icon: "\ud83d\udcb3", title: "Secure Payments", desc: "Integrated Stripe payment flow with support for cards and mobile wallets." },
    { icon: "\ud83d\udc68\u200d\ud83c\udf73", title: "Service Provider Dashboard", desc: "Service providers manage their listings, view orders, and update availability from a dedicated panel." },
    { icon: "\ud83d\udccd", title: "Location-based Search", desc: "Locations to suggest nearest Service Provider." },
  ];
      ...
      <div style={{ background: colors.bg, color: colors.text, minHeight: "100vh", position: "relative" }}>
        ...
        <div style={{ position: "relative" as const, minHeight: "85vh", display: "flex", flexDirection: "column" as const, justifyContent: "center", padding: "80px 24px 40px", overflow: "hidden" as const }}>
          ...
          <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }} style={{ fontSize: "1rem", color: colors.textDim, lineHeight: 1.7, marginBottom: "40px" }}>
            A modern mobile service booking platform where customers browse services from multiple providers, view ratings and availability, and place bookings \u2014 with real-time tracking from provider to customer.
          </motion.p>
        </div>
    ...
    <Kino>
      <div style={{ background: colors.bg, color: colors.text, minHeight: "100vh", position: "relative" }}>
        ...
        >
          ...
          >
            A modern mobile service booking platform where customers browse services from multiple providers,
            view ratings and availability, and place bookings {"\u2014"} with real-time tracking from provider to customer.
          </motion.p>
